...
local trench2D =
{
  ...
  medium =
  {
    { subsets = {"Inner"},
      ...
      permeability  = "@Sandstone" -- 1.019368e-9,  -- uid of a material or number
    },
  },
  ...
  time =
  {
    ...
    dt  = tstop/numdays,           -- [s] initial time step
  ...
  output =
  {
    file = "simulations/trench2D_hour_sandstone/", -- must be a folder!
